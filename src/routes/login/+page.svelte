  ...
  <form action="" class="flex flex-col mt-8 p-5 shadow border min-w-[320px] rounded-md">
    ...
    <div class="flex flex-col gap-5">
      <div class="flex justify-between gap-4 items-center">
        ...
        <input type="text" required name="username" id="username" placeholder="아이디를 입력하세요" class="input input-sm input-bordered input-primary w-full max-w-[180px]">
      </div>
      <div class="flex justify-between gap-4 items-center">
        <label for="password" class="min-w-fit text-sm">비밀번호</label>
        <input type="password" required name="password" id="password" placeholder="비밀번호를 입력하세요" class="input input-sm input-bordered input-primary w-full max-w-[180px]">
      </div>
